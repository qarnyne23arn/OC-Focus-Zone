  ...
  return (
    ...
    >
      <div
        ...
        className="relative w-full max-w-md rounded-3xl bg-[#061022] border border-cyan-500/30 shadow-[0_20px_60px_rgba(0,0,0,0.85)] p-6 sm:p-8 overflow-hidden text-slate-100 animate-in fade-in zoom-in-95 duration-200"
      >
        {/* Ambient Top Glow */}
        ...
        <button
          type="button"
          onClick={onClose}
          className="absolute top-5 right-5 p-2 rounded-full text-slate-400 hover:text-white hover:bg-slate-800/60 transition cursor-pointer"
          title="Close dialog"
        >
          <X className="w-5 h-5" />
        </button>
        ...
        <div className="flex flex-col items-center text-center mb-6">
          ...
          <h2 className="text-2xl font-black tracking-wider text-white font-['Plus_Jakarta_Sans']">
        ...
        <div className="mb-5 p-2.5 rounded-xl bg-cyan-500/10 border border-cyan-500/20 flex items-center gap-3">
          ...
          <p className="text-[11px] text-cyan-200/90 leading-tight">
            <span className="font-semibold text-cyan-300">Multi-Device Auto Sync:</span> Use one account on laptop, tablet, & phone with live auto-refresh.
          </p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-10 py-2.5 rounded-xl bg-slate-900/80 border border-slate-700/80 text-white placeholder-slate-500 text-sm focus:outline-none focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400 transition"
              />
              <button
                type="button"
